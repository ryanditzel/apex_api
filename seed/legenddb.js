...
const main = async () => {
    ...
    const bangalore =  new Legend({
        ...
        img: "https://i.ibb.co/LZcvXKt/bangalore.png"
    })
    ...
    const caustic =  new Legend({
        ...
        img: "https://i.ibb.co/3sfHSpt/caustic.png"
    })
    await caustic.save();
    ...
    const fuse =  new Legend({
        ...
        img: "https://i.ibb.co/2hBP5NN/fuse.png"
    })
    await fuse.save();

    const gibraltar =  new Legend({
        name: "Gibraltar",
        ...
        img: "https://i.ibb.co/zhKkRVj/gibraltar.webp"
    })
    ...
    const lifeline =  new Legend({
        ...
        img: "https://i.ibb.co/VBGbPmn/lifeline.webp"
    })
    await lifeline.save();
    ...
    const octane =  new Legend({
        ...
        img: "https://i.ibb.co/nPWf2r3/octane.png"
    })
    await octane.save();
    ...
    const pathfinder =  new Legend({
        ...
        img: "https://i.ibb.co/k6GjzY4/pathfinder.png"
    })
    ...
    const wraith =  new Legend({
        ...
        img: "https://i.ibb.co/vsPZ4CC/wraith.png"
    })
    await wraith.save();
